...
/datum/element/movetype_handler/Attach(datum/target)
	...
	if(movable_target.movement_type & (FLOATING|FLYING|SWIMMING) && !HAS_TRAIT(movable_target, TRAIT_NO_FLOATING_ANIM)) // NOVA EDIT CHANGE - ORIGINAL: if(movable_target.movement_type & (FLOATING|FLYING) && !HAS_TRAIT(movable_target, TRAIT_NO_FLOATING_ANIM))
...
/datum/element/movetype_handler/proc/on_movement_type_trait_gain(atom/movable/source, trait)
	...
	if(!(old_state & (FLOATING|FLYING|SWIMMING)) && (source.movement_type & (FLOATING|FLYING|SWIMMING)) && !HAS_TRAIT(source, TRAIT_NO_FLOATING_ANIM)) //NOVA EDIT CHANGE - ORIGINAL: if(!(old_state & (FLOATING|FLYING)) && (source.movement_type & (FLOATING|FLYING)) && !HAS_TRAIT(source, TRAIT_NO_FLOATING_ANIM))
...
/datum/element/movetype_handler/proc/on_movement_type_trait_loss(atom/movable/source, trait)
	...
	var/old_state = source.movement_type
	source.movement_type &= ~flag
	if((old_state & (FLOATING|FLYING|SWIMMING)) && !(source.movement_type & (FLOATING|FLYING|SWIMMING))) //NOVA EDIT CHANGE - ORIGINAL: if((old_state & (FLOATING|FLYING)) && !(source.movement_type & (FLOATING|FLYING)))
		STOP_FLOATING_ANIM(source)
...
/datum/element/movetype_handler/proc/on_no_floating_anim_trait_gain(atom/movable/source, trait)
	SIGNAL_HANDLER
	if(source.movement_type & (FLOATING|FLYING|SWIMMING)) //NOVA EDIT CHANGE - ORIGINAL: if(source.movement_type & (FLOATING|FLYING))
		STOP_FLOATING_ANIM(source)
